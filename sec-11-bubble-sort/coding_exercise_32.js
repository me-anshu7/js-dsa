 ...
 * the array to be compared. The function returns a negative value if the first 
 * value is less that the second, a positive value if the first value is greater
